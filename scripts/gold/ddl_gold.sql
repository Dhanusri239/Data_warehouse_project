...
/*===========================================================================================================
The Purpose of the script is to create views for gold layer in the datawarehouse and it represents the final
the final dimension and fact tables(star schema)
It provide business ready clean and enriched data
Note:This code may alter the views if it is already presented in your database
===========================================================================================================*/
--=========================================================================================================
...
LEFT JOIN silver.erp_px_cat_g1v2 AS pd
ON pr.cat_id=pd.id
